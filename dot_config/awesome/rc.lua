...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- NOTE: requires repo https://github.com/streetturtle/awesome-wm-widgets
  -- Custom widget begins
  ...
  -- NOTE: requires repo https://github.com/haikarainen/light#installation
  ...
  s.mywibox:setup {
      ...
      { -- Right widgets
          ...
          docker_widget { number_of_containers = 9 },
          batteryarc_widget({
...
globalkeys = gears.table.join(
        ...
        -- NOTE: mod
        awful.key({ modkey, "Control" }, "f", function() awful.tag.incmwfact(0.05) end,
        ...
        -- NOTE: CUSTOM KEY
        -- SYSTEM
        , awful.key({ modkey, "Shift" }, "s", function() awful.spawn.with_shell("sudo shutdown now") end,
        { description = "Shutdown Now", group = "System" }),
        ...
        end, { description = "Decrease sound volume", group = "Sound" }),
        awful.key({ modkey }, "F3", function()
          awful.spawn.with_shell("amixer -D pulse sset Master 5%+")
        end, { description = "Increase sound volume", group = "Sound" }),
        awful.key({ modkey }, "F1", function()
          awful.spawn("amixer -D pulse sset Master toggle")
        end, { description = "Mute/Unmute sound", group = "Sound" }),

        awful.key({ modkey }, "Delete",
            function()
              awful.spawn.with_shell("~/screenshot.sh")
              -- awful.spawn.with_shell("scrot -s -e 'xclip -selection clipboard -t image/png < $f'")
            end,
            { description = "Screenshot portion to clipboard", group = "System" })
...
for i = 1, 9 do
  globalkeys = gears.table.join(globalkeys,
      ...
      -- Media Keys (Requires xbacklight aand alsa-utils)
      -- REF: https://www.reddit.com/r/awesomewm/comments/nkgdgn/comment/gzdt4rr/?utm_source=share&utm_medium=web2x&context=3
...
-- awful.layout.suit.tile.left.add_new_tile = false
-- awful.layout.suit.tile.right.mirror = true
